...
1. **Period 0-dan Sonra Kəskin Müştəri İtkisi (Massive Churn):**
   ...
   * *Nəticə:* Bu, platformanın təkrar alış baxımından **çox zəif (weak repeat purchasing)** strukturuna malik olduğunu və müştərilərin 99%-dən çoxunun bir dəfə alıb bir daha geri qayıtmadığını sübut edir.
...
2. **Birdəfəlik Alıcılardan Yüksək Asılılıq:**
   * Biznesin gəlirləri tamamilə yeni müştərilərin cəlb edilməsinə (`new customer acquisition`) bağlıdır.
